...
prior_MindVoice <- c(
  ...
  prior(normal(0.1, 1), class = b),       # så er AI også
  prior(normal(1, 2), class = sigma) # average error we expect
) 
...
prior_MindApathy <- c(
  prior(normal(4, 1), class = Intercept), # It is a good guess that when voice hearing and mind reading er mean, 
  prior(normal(0.1, 1), class = b, coef = M_MindReading),# så er AI også
...
prior_VoiceApathy <- c(
  prior(normal(4, 1), class = Intercept), # It is a good guess that when voice hearing and mind reading er mean, 
  prior(normal(0.1, 1), class = b, coef = M_VoiceHearing),# så er AI også
  prior(normal(-0.5, 1), class = b, coef = M_Apathy),
  prior(normal(1, 2), class = sigma) # average error we expect
) 
